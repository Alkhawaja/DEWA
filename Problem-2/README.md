...
This package performs outdoor GPS waypoint navigation. It navigates while building a map, avoiding obstacles, and can navigate continuously between each goal or stop at each goal. 
